package proyectogrupo4.grupo4.authz.controller;
...
import proyectogrupo4.grupo4.authz.conf.JWTUtil;
import proyectogrupo4.grupo4.authz.entity.Authority;
import proyectogrupo4.grupo4.authz.entity.User;
import proyectogrupo4.grupo4.authz.service.AuthorityService;
import proyectogrupo4.grupo4.authz.service.UserService;
...
public class UserController {
    ...
    public ResponseEntity<String> hasAuthority(@RequestHeader("Authorization") String authHeader,
            @RequestHeader("Endpoint") String endpointHeader) throws SignatureException {
